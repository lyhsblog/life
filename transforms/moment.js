...
export const textHumanizer = (language) => {
...
// HumanData -> date
export const humanToDate = (humanDate) => {
  const date = new Date()
...
export const humanDateToYMD = ({ year, month, day }, separator = '-') => {
  const _month = month
...
export const isSameHumanDay = (target, target2) => {
  return (
...
export const timeAgo = (_time, language) => {
...
// Date to YMD am/pm
export const humanizeYMD = (date, language) => {
  if (!date) {
    return date
  }
